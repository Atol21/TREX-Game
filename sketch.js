...
function setup() {
    ...
    ground = createSprite(200, height-300, 400, 20);
    ...
    invisibleGround = createSprite(200, height-290, 400, 10);
...
function draw() {
    ...
    if (gameState === PLAY) {
        ...
        if (keyDown("space") && trex.y >= height-359) {
            trex.velocityY = -12;
        }
...
function spawnObstacles() {
    if (frameCount % 60 === 0) {
        var obstacle = createSprite(width, height-315, 10, 40);
        //obstacle.debug = true;
